...
const testObj = {
	...
	lastName: 'Virat',
	getName: function () {
		console.log('log inside object function = ', this);
...
console.log('createdObj.getName() = ', createdObj.getName());
...
console.log('after setting prototype of obj', setProtoParentObj);
